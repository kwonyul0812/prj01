...
/
CREATE TABLE item(item_no NUMBER PRIMARY KEY, sub_category_no NUMBER NOT NULL, name VARCHAR(30) NOT NULL, price NUMBER NOT NULL, FOREIGN KEY (sub_category_no) REFERENCES sub_category(sub_category_no))
/
